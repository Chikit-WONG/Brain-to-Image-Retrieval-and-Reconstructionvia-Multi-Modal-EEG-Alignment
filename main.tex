...
For generation, SimpleAlignPipe processes the EEG-derived image, depth, edge, and fusion embeddings; the aligned image, depth, and edge embeddings are then used as the direct IP-Adapter conditions for SDXL-Turbo, while the text and fusion embeddings contribute indirectly through training and alignment.
