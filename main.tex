...
\begin{equation}
  \mathcal{L} = -\frac{1}{2N}\sum_{i=1}^N \left[\log\frac{e^{\mathbf{z}_i \cdot \mathbf{v}_i}}{\sum_j e^{\mathbf{z}_i \cdot \mathbf{v}_j}} + \log\frac{e^{\mathbf{v}_i \cdot \mathbf{z}_i}}{\sum_j e^{\mathbf{v}_j \cdot \mathbf{z}_j}}\right]
\end{equation}
