...
\begin{table}[H]
\centering
\caption{Task 1 ablation: effect of blur levels and EVNet (95/5 split, mean $\pm$ std, 10 seeds, 200-way). The final row is the split-mode 8-blur + EVNet setting selected for ablation comparison. \textdagger~Best-test shown for reference only.}
...
12-blur                            & $82.4 \pm 1.9\%$ & $84.6 \pm 1.2\%$ & $86.9 \pm 0.6\%$ \\
12-blur + EVNet                    & $83.3 \pm 2.4\%$ & $85.3 \pm 1.4\%$ & $88.3 \pm 0.5\%$ \\
