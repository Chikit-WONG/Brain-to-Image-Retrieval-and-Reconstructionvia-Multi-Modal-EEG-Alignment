...
In the final generation stage, SimpleAlignPipe aligns the EEG-derived image, depth, edge, and fusion embeddings to the generation embedding space, and IP-Adapter-based SDXL-Turbo generation is conditioned directly on the image, depth, and edge embeddings.
...
For generation, SimpleAlignPipe then aligns the EEG-derived image, depth, edge, and fusion embeddings with their corresponding generation embedding distributions; the final IP-Adapter conditioning uses the aligned image, depth, and edge embeddings.
