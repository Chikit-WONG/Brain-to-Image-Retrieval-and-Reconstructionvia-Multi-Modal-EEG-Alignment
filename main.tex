...
\begin{table}[H]
\centering
\caption{Task 1 ablation: effect of blur levels and EVNet (95/5 split, mean $\pm$ std, 10 seeds, 200-way). The last two rows compare the 8-blur baseline against the matched 8-blur + EVNet setting used for ablation comparison. \textdagger~Best-test shown for reference only.}
...
EVNet, no blur                     & $73.4 \pm 2.1\%$ & $73.5 \pm 2.0\%$ & $77.9 \pm 1.5\%$ \\
8-blur                            & $82.8 \pm 2.3\%$ & $84.0 \pm 1.4\%$ & $87.1 \pm 0.9\%$ \\
\textbf{8-blur + EVNet (split-mode ablation)} & $\mathbf{83.6 \pm 2.1\%}$ & $\mathbf{85.4 \pm 1.7\%}$ & $\mathbf{88.2 \pm 0.9\%}$ \\
\bottomrule
\end{tabular}
\end{table}
